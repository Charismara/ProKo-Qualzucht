...
import Eigenes from 'public/WhatsApp Bild 2022-11-21 um 17.02.45.jpg';
import Costa from 'public/WhatsApp Bild 2022-11-21 um 17.15.30.jpg';
import Keil from 'public/7231f4cf3779e78915ab3287093343_original.jpg';
import Bull from 'public/kranker-hund-large.jpg';
                ...
                <div className="mx-auto max-w-7xl py-8 px-4 sm:py-8 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <p className="mt-1 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                            Listenhund Züchtungen
                        </p>
                        <div className="mx-auto mt-8 max-w-4xl text-xl">
                            <div className={"mt-8"}>
                                <p>Viele Menschen stellen sich eine bestimmte Größe bei ihrem Hund vor, und wenn diese noch nicht existiert, dann Züchten wir sie halt.</p>
                                <br/>
                                <p>Ein Problem, wenn man einen Hund groß Züchtet ist, dass diese sehr häufig Probleme mit den Knochen haben und der Körper so schwer ist, dass mit der Zeit Liegeschwielen entstehen.</p>
                                <br/>
                                ...
                                <br/>
                                <div className="group">
                                    <Image src={Eigenes} alt={""} style={{objectFit: "scale-down"}} className={"mx-auto w-1/2"}/>
                                ...
                                <br/>
                                <div className="group">
                                    <Image src={Costa} alt={""} style={{objectFit: "scale-down"}} className={"mx-auto w-1/2"}/>
                                    <h3 className="mt-3 text-sm text-gray-500 text-center">
                                        Eigenes Bild
                                    </h3>
                                </div>
                                <p>Häufig Leiden sie auch unter einem Keilwirbel dies bedeutet eine Wirbelkörperdeformation diese zeigen Ventral (Zum Bauch hin) betonten Höhenminderung des Wirbelkörpers einhergeht.</p>
                                <br/>
                                <p>Diese Deformation wird häufig bei Rottweilern, Westhighland White Terriern, Foxterriern, Yorkshire Terriern, Beagles und Deutsch-Kurzhaar festgestellt.</p>
                                <br/>
                                <p> Ein Keilwirbel hat meistens folgende Symptome, Bewegungs- und Koordinationsstörungen dazu folgen dann auch ab und zu Lähmungen.</p>
                                <br/>
                                <p>Häufig treten auch verminderte Reflexe auf sowie vermindertes Stehvermögen und Muskelatrophie der Hintergliedmaßen. Natürlich haben die Hunde auch an dem betroffenen wirbelabschnitte Schmerzen, die die
                                   Hunde sehr plagen.</p>
                                <br/>
                                ...
                                <p>Auch wie bei vielen anderen Hunden, haben manche American Bully’s eine viel zu kurze Nase und leiden deshalb auch häufig unter Atemproblemen und können auch deshalb nicht sehr viel Laufen.</p>
                                <br/>
                                <p>Manche Bully’s haben auch eine Fehlstellung des Augenlides, hier rollt sich das Augenlid nach innen. Dies kann schmerzhaft sein und die Hornhaut beschädigen.</p>
                                <br/>
                                <p>Alles in allem sind American Bully’s XL sehr geschädigte Tiere, immer viel zu viele Muskeln und sehr viele Körperlichen Probleme.</p>
                                <p className="mt-1 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                                ...
                                <br/>
                                <p>Oft haben Listenhunde auch Verhaltensauffälligkeiten, weil die Menschen nicht darauf achten welche Hunde sie miteinander züchten um ihre Zielzüchtung zu erreichen. Da kann es auch mal sein, dass die
                                   Listenhunde die eh schon verzüchtet sind auch noch mit einem Hund gezüchtet werden der starke Verhaltens Auffälligkeiten hat und seine nachfahren führen dann vielleicht das Verhalten in ihren Genen
                                   weiter.</p>
                                <br/>
                                <p>Die Problematik bei Listenhunden ist, dass sie immer im Trend sein werden und deshalb immer weiter mit ihnen gezüchtet wird auch wenn es schon bei vielen listen Hunden verboten wird. Viele Hunde werden
